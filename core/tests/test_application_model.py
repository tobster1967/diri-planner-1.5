...
class ApplicationModelTest(TestCase):
    ...
    def test_application_creation(self):
        ...
        app = Application.objects.create(name="Test App", description="Test description", slug="test-app")
    ...
    def test_application_slug_unique(self):
        ...
        with self.assertRaises(Exception):
            Application.objects.create(name="Duplicate", slug="app-a")  # Already exists
