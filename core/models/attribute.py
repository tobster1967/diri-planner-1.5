...
class Attribute(TreeNodeModel, Base):
    ...
    name = models.CharField(max_length=255, help_text="Name of the attribute")

    value = models.TextField(blank=True, help_text="Value of the attribute")
    ...
    description = models.TextField(blank=True, help_text="Description of what this attribute represents")

    is_active = models.BooleanField(default=True, help_text="Whether this attribute is active")

    metadata = models.JSONField(default=dict, blank=True, help_text="Additional metadata for the attribute")
